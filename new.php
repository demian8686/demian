...
echo "\e[37;1m*************** \e[93mMUHHAMAD DEMIAN PRATAMA\e[37;1m **************\n";
...
echo "\e[32;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
	goto login;
login:
echo "\e[93m▬▬▬ LANGSUNG CROOTT AJA  ▬▬▬▬▬\n";
$pass =  ( '║ User Login : ' );
echo "\033[30;40m";
...
// function change(){
        ...
        echo color("white","📶▶️ OTP OTW LURR ")."\n";
        otp:
        ...
        echo color("red","\n▬▬▬▬▬▬▬▬▬▬▬▬* BISMILAH *▬▬▬▬▬▬▬▬▬▬▬▬");
       echo "\n".color("purple","# CLAIM VOUCHER CROOTT");
       ...
       $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"MAUGOFOOD2107"}');
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
	      gocar:
        echo "\n".color("green","# CLAIM VOUCHER TERUS CROTT");
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
        gofood:
        echo "\n".color("white","# CLAIM VOUCHER UDAH MAU KELUAR");
        ...
        echo "\n".color("yellow","# CLAIM VOUCHER AHH CROOTT");
        echo "\n".color("white","# MANTAP");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(5);
        ...
        sleep(15);
        $boba09 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"MAUGOFOOD2107"}');
